...
const SORTS = [
  ...
  { label: 'Newest',    key: 'first_air_date' },
]
...
export default function TVShows() {
  ...
  const fetchFn  = (p) => tmdb.discoverTV(p, activeGenre, `${sortKey}.desc`, minRating)
  ...
  return (
    <div className="tv-page">
      ...
      <div className="tv-page__header" style={{ paddingTop: 88 }}>
        ...
        <h1 className="tv-page__title" style={{ color: '#c084fc' }}>TV Shows</h1>
